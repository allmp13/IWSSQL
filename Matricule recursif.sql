...
AS (
  -- Point de départ
SELECT e.[Code_de_l_UO_mère], e.[Code_de_l_UO], e.[Matricule_RH_du_responsable_1_de_l_UO], iif([Code_de_l_UO]='03030102','0',e.[Matricule_RH_du_responsable_1_de_l_UO])
FROM [UO] AS e
WHERE [Code_de_l_UO]='03030102'
UNION ALL
