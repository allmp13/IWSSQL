...
REM XCOPY "\\winlgme-p\d$\Applications\Isilog\IsilogWebSystem\IWSCommonFiles\IWSPROD\%%r" "%PATH_IWS_WS%IWSCommonFiles\%IWSCN%\%%r" /E/S/I/Y/C
DIR "\\winlgme-p\d$\Applications\Isilog\IsilogWebSystem\IWSCommonFiles\IWSPROD\%%r"
 )
